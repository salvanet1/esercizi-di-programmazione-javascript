...
var nunLines = Math.ceil(cats/inLine);
var missing = (numLines*inLine)-cats;

console.log('$(cats) gatti in fila per $(inLine) si unirono compatti in $(numLines) file. Nell'utima fila rimasero $(missing) posti gatti disponibili.');
